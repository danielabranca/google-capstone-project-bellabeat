---
title: "R HTML Notebook on BellaBeat Case Study"
author: "Daniela"
...
## Uploading data
```{r}
daily_activity <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/daily_activity.csv")
daily_activity_v2 <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/daily_activity_v2.csv")
merged_dataset <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/merged_dataset.csv")
sleep_v2 <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/sleep_v2.csv")
sleep_v3 <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/sleep_v3.csv")
hourly_steps <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/hourly_steps.csv")
hourly_steps_plot <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/hourly_steps_plot.csv")
sleep_steps <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/sleep_steps.csv")
heartrate <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/heartrate.csv")
heartrate_v2 <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/heartrate_v2.csv")
MinuteIntensities <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/MinuteIntensities.csv")
HeartrateVSIntensities <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/HeartrateVSIntensities.csv")
High_HR_while_Sedentary <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/High_HR_while_Sedentary.csv")
weight <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/weight.csv")
sleep <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/sleep.csv")
```
...
```{r}
hourly_steps <- read_csv("C:\\Users\\Asus\\Documents\\Data Analysis by Google\\Capstone\\fitness_data\\Fitabase Data 4.12.16-5.12.16/hourlySteps_merged.csv")
```
...
```
# plotting this *$%#! that for some reason I can't plot it because there's always an error
```
hourly_steps_plot  %>% 
